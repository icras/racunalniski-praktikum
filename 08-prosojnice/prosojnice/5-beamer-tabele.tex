...
\begin{frame}{Odkrivanje tabele po stolpcih}
	...
	\begin{center}
		\begin{tabular}{c|>{\onslide<2->}c>{\onslide<3->}c>{\onslide<4->}c>{\onslide<5->}c<{\onslide}}%c<{\onslide}}je tak zato da se prvi stolpc prou pokaze
	...
	\end{center}
\end{frame}
%c|> pomen da se prvi stolpec plus linija pokaze predn se nasledni