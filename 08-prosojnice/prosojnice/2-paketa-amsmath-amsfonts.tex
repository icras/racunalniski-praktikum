\begin{frame}{Matrike}
	...
	$$ %vsa ta okolja so definirana v paketu amsmat
	\begin{vmatrix} %vmatrix je da ti da verticalne črte oz da je to pol determinanta matrike
					%bmatrix da pa oglate oklepaje
		 -1 & 4 & 4 & -2 \\
		 1 & 4 & 5 & -1 \\
		 1 & 4 & -2 & 2 \\
		 3 & 8 & 4 & 3 \\
...
\begin{frame}{Okolje \texttt{align} in \texttt{align*}}
	...
	\begin{align*} %zvezdica zbriše stransko oštevilčenje
				   %&pred enačajem je da se poravnajo po enačajih
		(a+b)^n \only<1>{=\ldots \\}
...
\begin{frame}{Še ena uporaba okolja \texttt{align*}}
	...
	% boste lahko oblikovali vse tri vrstice hkrati. &pomeni tako poravnava kot tudi preskok na naslednji stolpec
