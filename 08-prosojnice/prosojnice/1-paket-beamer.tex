...
\begin{frame}{Tudi v predstavitvah lahko pišemo izreke in dokaze}
	...
	\begin{proof}
	   ...
	   \begin{itemize}[<+->]
		  \item Naj bo $p$ \alert<4>{največje} praštevilo.%ukaz ima učinek samo na četrti prosojnici
		  \item Naj bo $q$ produkt števil $1$, $2$, \ldots, $p$.
		  \item Število $q+1$ ni deljivo z nobenim praštevilom, torej je $q+1$ praštevilo.
		  \item To je protislovje, saj je $q+1>p$. \qedhere %quedhere pove da hocmo v tej vrstici zaključit dokaz ker se drugače napiše avtomatično v eni vrstici nižje
	   \end{itemize}
	\end{proof}
 \end{frame}
